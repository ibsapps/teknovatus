...
class M_master extends CI_Model {
    ...
    public function feed_karyawan() {
        ...
        $sql['jvals'] = array('tb2.id');
        $sql['field'] = array('tb1.id as cbox', 'tb1.nik', 'tb1.nama_lengkap', 'tb2.dept', 'tb1.email', 'tb1.level','tb1.try');
    ...
    public function search_barang($q="") {
     ...
     public function get_karyawan($id="") {
        ...
        $sql['jcols'] = array('tb1.id_department');
        $sql['jvals'] = array('tb2.id');
        $sql['field'] = array('tb1.id', 'tb1.nik', 'tb1.nama_lengkap', 'tb2.id as id_departement', 'tb2.dept', 'tb1.email', 'tb1.level', 'tb1.gsm','tb1.try');
        $sql['order'] = "tb1.nama_lengkap ASC";
        if($id!="") {
