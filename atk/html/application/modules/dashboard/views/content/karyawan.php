<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Master Data Karyawan</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="#" method="POST" name="batchExec" id="batchExec">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataKaryawan" data-src="<?Php echo $feedUri ?>">
                                <thead>
                                    <tr>
