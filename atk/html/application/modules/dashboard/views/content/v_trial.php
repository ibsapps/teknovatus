...
<div>
	<div style="width:100%;padding-top:20px;" >
			...
			<div style="width:100%;">
				<table class="nilai1" >
					<tr><td style="text-align:center;"><b><font size="4">LAPORAN DATA ATK <?php echo ".$tanggal." ?>
					</font></b></td></tr>
				</table>
                <hr/>
				<table class="bredak-before special nilai2" >
					<thead>
						<tr>
							...
							<th style="width:8%;text-align:center;" >Stock Awal</th> 
							<th style="width:8%;text-align:center;" >qty try</th> 
...
?>
							...
							<td style="text-align:center;"><?php echo $result['satuan'];?></td>
							  <td><?php echo $result['stock_ready'];?></td>
							  <td><?php echo $result['qty_try'];?></td>
 						</tr>
<?php 
