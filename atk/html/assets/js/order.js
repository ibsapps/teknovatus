...
//        responsive: false,
    ...
    $('#add_barang').on('click', function () {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (x) {
                if (x.status === true && x.stock_ready>jmlOrderBarang) {
                    try {
                    ...
                    alert('Out of stock (batas stock '+x.stock_ready+', permintaan '+jmlOrderBarang+')');
                }
            },
            error: function (data) {
