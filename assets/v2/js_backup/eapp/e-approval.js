...
// RESPONSE
$("#eapp-approved").click(function (e) {
    e.preventDefault();
    ...
    if (new_employee_flag == 1) {
        ...
        if ((final_score == 0) || (final_score == '')) {
            Swal.fire({ position: 'top-end',icon: 'error', title: 'Please check Final Score.',showConfirmButton: false, timer: 2000});
            return false;
        }

        if ((final_score > 10)) {
            Swal.fire({ position: 'top-end',icon: 'error', title: 'Please enter Final Score less than or equal to 10.',showConfirmButton: false, timer: 2000});
            return false;
        }
    }
...
function validateCodeApproved() {
    ...
    $.ajax({
        ...
        type: 'post',
        data: 'id=' + request_id + '&otp=' + otp + '&request_number=' + request_number + '&approval_id=' + approval_id+ '&final_score=' + final_score,
        dataType: 'json',
        success: function (response) {
