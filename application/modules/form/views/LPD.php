                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-control-wrap">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="ppd_request_number" id="ppd_request_number"class="form-control" placeholder="Masukan HRIS PPD Request Number" required>
                                                <div class="input-group-prepend">
                                            ...
                                            <div class="form-group">
                                                <div class="form-control-wrap focused">
                                                    <span class="tb-odr-id lead-primary w-50">
                                                        <input type="number" oninput="maxLengthCheck(this)" maxlength="8" min="1" max="8" onkeypress="return isNumeric(event)" <?=$disabled?> name="lpd_employee_nik" id="lpd_employee_nik" class="form-control form-control-outlined form-control-md" placeholder="Masukan 8 digit NIK lalu tekan Enter" value="<?php if (!empty($detail["nik_pejalan_dinas"])) echo $detail["nik_pejalan_dinas"]; ?>">
                                                        <label class="form-label-outlined text-primary" for="lpd_employee_nik">NIK Pejalan Dinas</label>
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="table-responsive-sm">
                                                ...
                                                <table class="table table-tranx is-compact fs-13px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" readonly class="form-control" name="grand_total_tb" id="grand_total_tb" value="<?php echo ($header['claim_total'] == 0) ? 0 : rupiah($header['claim_total']); ?>">

                                                            <input type="hidden" class="form-control" name="grand_total" id="grand_total" value="<?php echo ($header['claim_total'] == 0) ? 0 : $header['claim_total']; ?>">
                                                        </td>
                                                    </tr>
                                                    </tr>
                                                        <td>NOMINAL PPD</td>
                                                        <td>
                                                            <input type="text" readonly class="form-control" name="nominal_ppd_tb" id="nominal_ppd_tb" value="<?php echo ($detail['nominal_ppd'] == 0) ? 0 : rupiah($detail['nominal_ppd']); ?>">

                                                            <input type="hidden" class="form-control" name="nominal_ppd" id="nominal_ppd" value="<?php echo ($detail['nominal_ppd'] == 0) ? 0 : $detail['nominal_ppd']; ?>">
                                                        </td>
                                                    </tr>
                                                    </tr>
                                                        ...
                                                        <td>
                                                            <div class="custom-control custom-radio">
                                                                <input type="checkbox" <?=$disabled;?> class="custom-control-input" <?php if (!empty($detail["sisa_lebih_sudah_dibayar"]) && $detail["sisa_lebih_sudah_dibayar"] === "Y") echo 'checked'; ?> name="sisa_lebih_belum_dibayar_ya" id="sisa_lebih_belum_dibayar_ya" value="1" tabIndex="1">
                                                                <label class="custom-control-label form-label" for="sisa_lebih_belum_dibayar_ya">YA</label>
                                                            </div>
                                                            <span>&nbsp;</span>
                                                            <div class="custom-control custom-radio">
                                                                <input type="checkbox" <?=$disabled;?> class="custom-control-input" <?php if (!empty($detail["sisa_lebih_belum_dibayar"]) && $detail["sisa_lebih_belum_dibayar"] === "N") echo 'checked'; ?> id="sisa_lebih_belum_dibayar_no" name="sisa_lebih_belum_dibayar_no" value="1" tabIndex="1">
                                                                <label class="custom-control-label form-label" for="sisa_lebih_belum_dibayar_no">BELUM</label>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            <div class="modal-body modal-body-md">
                ...
                <form action="#" class="pt-2 form-validate is-alter">
                    <div class="row gy-3 gx-gs">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-label" for="modal_material_code">Diem 
                                    <span class="text-danger" id="text_max_diem_lpd"></span>
                                </label>
                                <input type="number" oninput="check_max_diem_lpd()" onkeypress="return isNumeric(event)" onchange="return calculate_lpd_item();" onClick="return calculate_lpd_item();" onKeyUp="return calculate_lpd_item();" class="form-control" required name="modal_perdiem" id="modal_perdiem">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label class="form-label" for="modal_material_code">Hotel 
                                    <span class="text-danger" id="text_max_hotel_lpd"></span>
                                </label>
                                <input type="number" oninput="check_max_hotel_lpd()" onkeypress="return isNumeric(event)" onchange="return calculate_lpd_item();" onClick="return calculate_lpd_item();" onKeyUp="return calculate_lpd_item();" class="form-control" required name="modal_hotel" id="modal_hotel">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
