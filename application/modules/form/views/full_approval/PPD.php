    ...
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
            <div class="btn-group-sm" aria-label="Basic example">  
                ...
                <!-- <button type="button" id="resubmit_ppd" class="btn btn-dim btn-gray" style="display: <?=$show?>"><em class="icon ni ni-send"></em>&nbsp; Submit</button>   -->
                <!-- <?php } else { ?> -->
               
                <!-- <?php } ?> -->
                 <button type="button" id="submit_ppd" class="btn btn-dim btn-gray" style="display: <?=$show?>"><em class="icon ni ni-send"></em> &nbsp;Submit</button>

                <button type="button" id="save_ppd" class="btn btn-dim btn-gray" style="display: <?=$show?>"><em class="icon ni ni-save"></em>&nbsp; Save</button>
                                        ...
                                        <tr class="tb-odr-item">
                                            ...
                                            <td class="tb-odr-info">
                                                <div class="form-group">
                                                    <div class="form-control-wrap focused">
                                                        <span class="tb-odr-id lead-primary w-50">
                                                            <input type="text" disabled name="range_grade" id="range_grade" class="form-control form-control-outlined form-control-md" value="<?php if (!empty($detail[0]["grade"])) { echo $detail[0]["grade"]; } ?>">
                                        ...
                                        <tr class="tb-odr-item">
                                            ...
                                            <td class="tb-odr-info">
                                                <div class="form-group">
                                                    <div class="form-control-wrap focused">
                                                        <span class="tb-odr-id lead-primary w-50">
                                                            <input type="text" disabled name="kota_keberangkatan" id="kota_keberangkatan" class="form-control form-control-outlined form-control-md" value="<?php $kota_berangkat;?>">
                                        ...
                                        <tr class="tb-odr-item">
                                            <td class="tb-odr-info">
                                                <div class="form-group">
                                                    <div class="form-control-wrap focused">
                                                        <span class="lead-primary">
                                                            <input type="text" <?=$disabled;?> name="waktu_berangkat" id="waktu_berangkat" onchange="return calculate_total_hari_ppd();" class="form-control form-control-outlined form-control-md time-picker" autocomplete="off" placeholder="Pilih Jam" required value="<?php if (!empty($detail[0]["waktu_berangkat"])) echo str_replace('.0000000', '', $detail[0]["waktu_berangkat"]); ?>">
                                                    ...
                                                    <table class="table table-orders" id="table_matrix">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <!-- <td>
                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" id="divhead" tabIndex="1" checked disabled>
                                                                        <label class="custom-control-label" for="divhead">Div. Head</label>
                                                                    </div>
                                                                </td> -->
                                                            ...
                                                            <tr>
                                                               <!--  <td>
                                                                    <div class="custom-control custom-control-sm custom-checkbox">
                                                                        <input type="checkbox" class="custom-control-input" id="c_level" tabIndex="1" checked disabled>
                                                                        <label class="custom-control-label" for="c_level">C-LEVEL</label>
                                                                    </div>
                                                                </td> -->
