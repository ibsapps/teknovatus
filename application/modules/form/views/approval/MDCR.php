    ...
    <div class="nk-ibx-head-actions">
        ...
        <li class="ml-n2">
            <?php if ($this->session->userdata('access_employee') == '12'){ ?>
                <a href="<?= site_url('inbox/approval_mdcr'); ?>" class="btn btn-icon btn-tooltip" title="Back">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <ul class="link-list-opt no-bdr">
                            ...
                            <?php
                                $is_status_admin_hr = $form_request['is_status_admin_hr'];
                                $form_type = $form_request['form_type'];
                                if(($is_status_admin_hr == 0) && ($form_type == 'MDCR') && ($this->session->userdata('access_employee') == '12')){
                            ?>
                                <li><a class="dropdown-item" onclick="return responseRequest_CekMDCR(this.id);" id="Checked_List_MDCR"><span>Checked</span></a></li>
                                <!-- <li><a class="dropdown-item" onclick="return responseRequest(this.id);" id="Approved"><span>Approved</span></a></li> -->
                                <!-- <li><a class="dropdown-item" id="eapp-approved"><span>Approved</span></a></li> -->
                            <?php
                                }else if(($this->session->userdata('access_employee') != '12') && ($this->session->userdata('access_level') != '9')){
                            ?>
                                <li><a class="dropdown-item" onclick="return responseRequest(this.id);" id="Approved"><span>Approved</span></a></li>
                                <!-- <li><a class="dropdown-item" id="eapp-approvedMDCR"><span>Approve</span></a></li> -->
                            <?php
                                }else if(($this->session->userdata('access_employee') != '12') && ($this->session->userdata('access_level') == '9') && ($approval_priority->approval_priority == '1')){
                            ?>
                                <li><a class="dropdown-item" onclick="return responseRequest(this.id);" id="Approved"><span>Approved</span></a></li>
                            <?php
                                }else{
                    ...
                    <div class="row gy-3 gx-gs">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Dokter Name" name="docter" id="docter">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
...
<div class="modal fade" tabindex="-1" id="modalEditPrice">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <a href="#" class="close" data-dismiss="modal" aria-label="Close"> <em class="icon ni ni-cross-sm"></em></a>
      <div class="modal-body modal-body-md">
        ...
        <form action="#" id="form_Edit_Claim" class="pt-2 form-validate is-alter">
          <input type="hidden" class="form-control" required name="record_id" id="record_id" value="">
          <input type="hidden" class="form-control" required name="request_id" id="request_id" value="<?= $header['request_id'];?>">
          <input type="hidden" class="form-control" required name="marital_status" id="marital_status" value="<?= decrypt($header['marital_status']);?>">
          ...
          <div class="row gy-3 gx-gs">
              <div class="col-6">
                  <div class="form-group">
                      <label class="form-label" for="request_grandparent_edit">Jenis Penggantian</label>           
                          <select class="form-select select-search_edit_claim request_grandparent_edit" disabled="true" name="request_grandparent_edit" placeholder="Jenis Penggantian" id="request_grandparent_edit">
              ...
              <div class="col-6">
                  ...
                  <label class="form-label" for="request_parent_edit">Sub Penggantian</label>
                      <select class="form-select select-search_edit_claim request_parent_edit" disabled="true" name="request_parent_edit" placeholder="Sub Penggantian" id="request_parent_edit">
                                  <!-- <option value="">Select Parent</option> -->
                      </select>    
                  </div>
              </div>
              <div class="col-6">
                  ...
                  <label class="form-label" for="request_child_edit">Detail Penggantian</label> 
                      <select class="form-select select-search_edit_claim request_child_edit" disabled="true" name="request_child_edit" placeholder="Penggantian" id="request_child_edit">
                                  <!-- <option value="">Select Child</option> -->
                      </select>    
                  </div>
              </div>
              ...
              <div class="col-6">
                  <div class="form-group">
                      <label class="form-label">Jumlah Kuitansi</label>
                      <input type="number" class="form-control" disabled="true" min="1" placeholder="Jumlah Kuitansi" name="jumlah_kuitansi_edit" id="jumlah_kuitansi_edit">
                  </div>
              </div>
              <div class="col-6">
                  <div class="form-group">
                      <label class="form-label">Tanggal Kuitansi</label>    
                          <input type="text" class="form-control date-picker" data-date-end-date="0d" disabled="true" name="tanggal_kuitansi_edit" id="tanggal_kuitansi_edit">    
                      <div class="form-note">Date format <code>mm/dd/yyyy</code></div>
                  </div>
              </div>
              <div class="col-6">
                  <div class="form-group">
                      <label class="form-label">Total Nominal Kuitansi</label>
                      <input type="text" class="form-control" disabled="true" placeholder="Total Nominal Kuitansi" name="total_nominal_kuitansi_edit" id="total_nominal_kuitansi_edit">
                  </div>
              </div>
              <div class="col-6">
                  <div class="form-group">
                      <label class="form-label">Dokter</label>
                      <input type="text" class="form-control" disabled="true" placeholder="Docter Name" name="docter_edit" id="docter_edit">
                  </div>
              </div>
              <div class="col-12">
                  <div class="form-group">
                  <label class="form-label">Diagnosa</label>
                      <textarea rows="1" name="diagnosa_edit" disabled="true" id="diagnosa_edit" placeholder="Diagnosa" class="form-control"></textarea>
                  </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label class="form-label">Penggantian</label>
                  <div class="form-control-wrap">
                      <input type="number" class="form-control" disabled="true" placeholder="Penggantian" readonly name="old_penggantian" id="old_penggantian">
                  </div>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label class="form-label">Penggantian Revisi</label>
                  <div class="form-control-wrap">
                      <input type="number" class="form-control" placeholder="Penggantian Revisi" name="penggantian_revisi" id="penggantian_revisi">
                  </div>
                </div>
              </div>
              <div class="col-12">
                  <div class="form-group">
                  <label class="form-label">Note Penggantian Revisi</label>
                      <textarea rows="1" name="note_penggantian" id="note_penggantian" placeholder="Note Penggantian" class="form-control"></textarea>
                  </div>
              </div>
              <div class="col-12">
                  <div class="form-group">
              ...
              <div class="col-12">
                  <div class="form-group">
                      <a href="#" class="btn btn-danger close_tor" data-dismiss="modal"> Cancel</a>
                      <button type="button" class="btn btn-primary req_medical_ubah_harga" id="req_medical_ubah_harga" item_value="">Save Informations</button>
                  </div>
              </div>
          </div>
        </form>
