<div class="nk-ibx-head">
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
          <h4 class="title ff-base"><?=strtoupper($this->session->userdata('division'));?> & <?=strtoupper($this->session->userdata('second_division'));?><span class="text-soft"> DIVISION</span></h4>
        </ul>
    </div>
</div>
...
<div class="nk-ibx-reply nk-reply" data-simplebar>
    ...
    <ul class="nav nav-tabs nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#tabItem5">
                ...
                <span><?=$this->session->userdata('division')?></span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#tabItem6">
                <?=status_division_icon($second_division_status['is_status']);?>
                <span><?=$this->session->userdata('second_division')?></span>
            </a>
        </li>
    </ul>
    ...
    <div class="tab-content mt-0">
        ...
        <div class="tab-pane active" id="tabItem5">
                                    ...
                                    <ul class="nk-ibx-head-tools g-1">
                                       <li class="ml-n2" style="display: <?=$show?>">
                                            <a onclick="return responseDivision(this.id)" id="submit_to_hr" class="btn btn-icon btn-tooltip" title="Submit to HR">
                                                ...
                                                Submit <?=$this->session->userdata('division')?> to HR
                                            </a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="card card-preview">
                <div class="card-inner">
                    <table class="datatable-init-export nowrap table" data-export-title="Export Data" data-ajaxsource="<?= site_url('inbox/read/'); ?>">
                        <thead>
                            <tr>
                                <th>NIK</th>
                                <th>Name</th>
        ...
        <div class="tab-pane" id="tabItem6">
            <?php if ($second_division_status['is_status'] == 3 || $second_division_status['is_status'] == 1) {
                $show = 'none';
            } else {
                $show = '';
            } ?>
                        ...
                        <div class="row g-gs">
                             <div class="col-lg-6 col-xxl-6">
                                 <div class="nk-ibx-head-actions">
                                    <ul class="nk-ibx-head-tools g-1">
                                       <li class="ml-n2" style="display: <?=$show?>">
                                            <a onclick="return responseDivision(this.id)" id="submit_to_hr_second_division" class="btn btn-icon btn-tooltip" title="Submit to HR">
                                                <em class="icon ni ni-send"></em>
                                                Submit <?=$this->session->userdata('second_division')?> to HR
                                            </a>
                                        </li>
                                    </ul>
                                </div>
            ...
            <div class="card card-preview">
                <div class="card-inner">
                    <table class="datatable-init-export nowrap table" data-export-title="Export Data" data-ajaxsource="<?= site_url('inbox/read_by_division/'.$this->session->userdata('second_division')); ?>">
                        <thead>
                            <tr>
                                <th>NIK</th>
                                <th>Name</th>
