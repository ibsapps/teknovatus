								...
								<tr>
									<td class="content-block">
										<?php if (!empty($data_employee_approver)): ?>
											Dear <b><?php echo (decrypt($data_employee_approver[0]->complete_name)); ?></b>, <br><br>
										<?php else: ?>
											Dear <b>Mr/Mrs</b>, <br><br>
										<?php endif ?>
										Medical claim documents with number: <?php echo $form_request['request_number']; ?> need approval. <br>
										Please <a href="<?php echo base_url();?>">sign in</a> to HRIS application.
									</td>
								</tr>	
							</table>
						</td>
					...
					<tr>
						<td class="content-wrap">
							<table width="100%" style="text-align: justify;">
								<tr>
									<th><span class="label info">Detail Request</span></th>
								</tr>
								<tr>
									<td class="content-block">
										Request Number
								...
								<tr>
									...
									<td class="content-block">
										<?php echo $form_request['form_type']; ?>
									</td>
								</tr>	
								<tr>
									<td class="content-block">
									...
									<td class="content-block">
										<?php echo $form_request['created_at']; ?>
									</td>
								</tr>	
								<tr>
									<td class="content-block">
									...
									<td class="content-block">
										<?php echo status_color($form_request['is_status']); ?>
									</td>
								</tr>	
								<tr>
									<td class="content-block">
									...
									<td class="content-block">
										<?php echo number_format($get_data_claim); ?>
									</td>
								</tr>	
							</table>
						</td>
