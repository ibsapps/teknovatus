							...
							<table width="100%" cellpadding="0" cellspacing="0" style="text-align: justify;">
								<tr>
									<td class="content-block">
										...
										Medical claim documents with number: <?php echo $form_request['request_number']; ?> was rejected!. <br>
										Please <a href="<?php echo base_url();?>">sign in</a> to HRIS application. To check!
									</td>
								</tr>	
							</table>
						</td>
