							...
							<table width="100%" cellpadding="0" cellspacing="0" style="text-align: justify;">
								<tr>
									<td class="content-block">
										Dear <b><?php echo (decrypt($data_employee->complete_name)); ?></b>, <br><br>
										Your request has been approved by <b><?php echo (decrypt($data_employee_approver->complete_name)); ?>. Please wait for checking by HR.<br>
