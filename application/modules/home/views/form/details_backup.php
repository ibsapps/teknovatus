            ...
            <li style="display: <?=$show?>">
                <div class="dropdown">
                    <a href="#" class="dropdown-toggle btn btn-icon btn-trigger" data-toggle="dropdown">
                        <em class="icon ni ni-more-v"></em> Action
                    </a>
                    <div class="dropdown-menu">
                        <ul class="link-list-opt no-bdr">
                            <li><a class="dropdown-item" id="eapp-pullback"><span>Reset approval</span></a></li>
                        </ul>
                    </div>
                </div>
            </li>
...
<div class="nk-ibx-reply nk-reply" data-simplebar>
    ...
    <div class="nk-ibx-reply-head">
        <div>
            <h4 class="title"><span class="text-soft"></span>PERFORMANCE APPRAISAL & PLAN</h4>
