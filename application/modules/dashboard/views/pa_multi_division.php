...
<div class="nk-ibx-reply nk-reply" data-simplebar>
    ...
    <div class="tab-content mt-0">
        ...
        <div class="tab-pane" id="tabItem6">
                                ...
                                <div class="card card-bordered h-100">
                                    ...
                                    <div class="nk-tb-list is-loose traffic-channel-table">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col nk-tb-channel"><span>Grade</span></div>
                                            <div class="nk-tb-col nk-tb-sessions"><span>Total</span></div>
                                            <div class="nk-tb-col nk-tb-sessions"><span>Basic Line</span></div>
                                        </div><!-- .nk-tb-head -->
                                        <div class="nk-tb-item">
                                             <div class="nk-tb-col nk-tb-channel">
                                                <span class="tb-lead">9.1 - 10.0</span>
            ...
            <div class="card card-preview">
                <div class="card-inner">
                    <table class="datatable-init-export nowrap table" data-export-title="Export Data" data-ajaxsource="<?= site_url('dashboard/read_by_division/'.$this->session->userdata('second_division')); ?>">
                        <thead>
                            <tr>
                                <th>NIK</th>
                                <th>Name</th>
