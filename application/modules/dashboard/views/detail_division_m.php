...
<div class="nk-ibx-head">
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
            <li class="ml-n2">
                <a href="<?= site_url('dashboard/m_division'); ?>" class="btn btn-icon btn-tooltip" title="Back">
...
<div class="nk-ibx-reply nk-reply" data-simplebar>
    ...
    <div class="card card-preview">
        <div class="card-inner">
            <table class="datatable-init-export nowrap table" data-export-title="Export Data" id="tableDivHead" data-ajaxsource="<?= site_url('dashboard/read_c_division/'.str_replace('&', '-', $division_status['division_name'])); ?>">
                <thead>
                    <tr>
                        <th>NIK</th>
                        <th>Name</th>
