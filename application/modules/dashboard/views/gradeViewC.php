<div class="nk-ibx-head">
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
            <li class="ml-n2">
                <a href="<?= site_url('dashboard/c'); ?>" class="btn btn-icon btn-tooltip" title="Back">
...
<div class="nk-ibx-reply nk-reply" data-simplebar>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-2">
                                                    <div class="card-title">
                                                        <h6 class="title text-soft">Total Team Members</h6>
                                                    </div>
                                                    <div class="card-tools">
                                                        <em class="card-hint icon ni ni-help-fill" data-toggle="tooltip" data-placement="left" title="Total Team Members for <?=strtoupper($this->session->userdata('division')); ?>"></em>
                                                    </div>
                                                </div>
                                                <div class="align-end flex-sm-wrap g-4 flex-md-nowrap">
                                                    <div class="nk-sale-data">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="card card-bordered">
                                            <div class="card-inner">
                                                <div class="card-title-group align-start mb-2">
                                                    <div class="card-title">
                                                        <h6 class="title text-soft">Total PA Submission</h6>
                                                    </div>
                                                    <div class="card-tools">
    ...
    <div class="nk-ibx-reply-group">
        <div class="card card-preview">
            ...
            <div class="card-inner">
                <table class="nowrap table tableDashboard" data-export-title="Export Data" data-ajaxsource="<?= site_url('dashboard/read_c/'. $this->uri->segment(3)); ?>">
                    <thead>
                        <tr>
                            <th>NIK</th>
                            <th>Name</th>
