    ...
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
            <li>
                 ...
                 <strong>EVALUATION PERIOD: <span class="text-primary"> Januari 2020 - Desember 2020</span></strong>
            </li>
        </ul>
    </div>
</div>
...
<div class="nk-ibx-reply nk-reply" data-simplebar>
                                        ...
                                        <div class="card card-bordered h-100">
                                            ...
                                            <div class="nk-tb-list is-loose traffic-channel-table">
                                                ...
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col nk-tb-channel">
                                                        <a class="btn btn-icon btn-trigger text-primary" id="a" onclick="return gradeViewHr(this.id)"><em class="icon ni ni-eye"></em> Details</a>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-item">
                                                     <div class="nk-tb-col nk-tb-channel">
                                                    ...
                                                    <div class="nk-tb-col nk-tb-channel">
                                                        <a class="btn btn-icon btn-trigger text-primary" id="b" onclick="return gradeViewHr(this.id)"><em class="icon ni ni-eye"></em> Details</a>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-item">
                                                     <div class="nk-tb-col nk-tb-channel">
                                                    ...
                                                    <div class="nk-tb-col nk-tb-channel">
                                                        <a class="btn btn-icon btn-trigger text-primary" id="c" onclick="return gradeViewHr(this.id)"><em class="icon ni ni-eye"></em> Details</a>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-item">
                                                     <div class="nk-tb-col nk-tb-channel">
                                                    ...
                                                    <div class="nk-tb-col nk-tb-channel">
                                                        <a class="btn btn-icon btn-trigger text-primary" id="d" onclick="return gradeViewHr(this.id)"><em class="icon ni ni-eye"></em> Details</a>
                                                    </div>
                                                </div>
                                                <div class="nk-tb-item">
                                                     <div class="nk-tb-col nk-tb-channel">
                                                    ...
                                                    <div class="nk-tb-col nk-tb-channel">
                                                        <a class="btn btn-icon btn-trigger text-primary" id="e" onclick="return gradeViewHr(this.id)"><em class="icon ni ni-eye"></em> Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="nk-ibx-reply-group">
        <div class="card card-preview">
            ...
            <div class="card-inner">
                <table class="nowrap table tableDashboard" data-export-title="Export Data" id="tableHR" data-ajaxsource="<?= site_url('dashboard/read_hr/all'); ?>">
                    <thead>
                        <tr>
                            <th>NIK</th>
                            <th>Name</th>
