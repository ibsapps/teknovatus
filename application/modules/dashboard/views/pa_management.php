...
<div class="nk-ibx-reply nk-reply" data-simplebar>
    ...
    <div class="nk-ibx-reply-head">
        <div>
            <h4 class="title ff-base"><?=strtoupper($this->session->userdata('division'));?> <span class="text-soft">DIVISION</span></h4>
        </div>
        <ul class="d-flex g-1">
    ...
    <div class="card card-preview">
        <div class="card-inner">
            <table class="datatable-init-export nowrap table" data-export-title="Export Data" id="tableDivHead" data-ajaxsource="<?= site_url('inbox/read'); ?>">
                <thead>
                    <tr>
                        <th>NIK</th>
                        <th>Name</th>
