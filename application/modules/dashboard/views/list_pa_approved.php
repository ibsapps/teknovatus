<div class="nk-ibx-head">
    <div class="nk-ibx-head-actions">
        <ul class="nk-ibx-head-tools g-1">
            <li>
                <a href="<?= site_url('inbox/pa_management'); ?>" class="btn btn-icon btn-trigger"><em class="icon ni ni-undo"></em></a>
            </li>
        </ul>
    </div>
    <div>
        <ul class="nk-ibx-head-tools g-1">
            ...
            <li class="mr-n1 d-lg-none">
                <a href="<?= site_url('inbox/pa_management'); ?>" class="btn btn-trigger btn-icon toggle" data-target="inbox-aside"><em class="icon ni ni-menu-alt-r"></em></a>
            </li>
        </ul>
    </div>
...
<div class="nk-ibx-list" data-simplebar>
    ...
    <?php $url = base_url('inbox/view/'.encode_url($value["id"])); ?>
    ...
    <div class="nk-ibx-item is-unread" onclick="location.href='<?=$url;?>'" style="display: show;">
        ...
        <div class="nk-ibx-item-elem nk-ibx-item-user">
            <div class="user-card">
                <div class="user-name">
                     <div class="lead-text text-primary"><?= $value['created_by'];?></div>
                </div>
            </div>
        </div>
